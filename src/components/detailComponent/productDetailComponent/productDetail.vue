        ...
        computed:{
            handleQuantityValue(){
                let products = {
                    ...
                    totalPrice:this.productById.price*this.valueQuantity
                    ...
                    <div class="product__details__pic">
                        <div class="product__details__pic__item">
                            <img class="product__details__pic__item--large"
                                :src="this.productById.image" alt="">
                        </div>
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="product__details__text">
                        ...
                        <div class="product__details__quantity">
                            <div class="quantity">
                                <div class="pro-qty">
                                    <input type="text" v-model="valueQuantity">
                                </div>
                                <!-- {{this.dataCart}} -->
                                <!-- {{this.valueQuantity}} -->
                           <!-- <button @click="addQuantity(this.valueQuantity++)">+</button> -->
                            </div>
                        </div>
                        <a  class="primary-btn" v-on:click="handleQuantityValue">ADD TO CARD</a>
                        <a href="#" class="heart-icon"><span class="icon_heart_alt"></span></a>
                        <ul>
                            <li><b>category</b> <span>{{this.productById.category}}</span></li>
